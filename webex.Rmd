...
Dale and Lisa are developing an R package called [`webex`](https://github.com/dalejbarr/webex) to make it easier to make web-based exercises. It provides an RMarkdown template and a few function to make questions that automatically give feedback and hint or solution buttons.
...
- "I `r mcq(c(answer = "bless the rains", "guess it rains", "sense the rain", "bless the waves"))` down in Africa" -Toto
